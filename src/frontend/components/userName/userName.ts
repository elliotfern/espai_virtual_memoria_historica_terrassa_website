...
export async function nameUser(): Promise<void> {
  const urlAjax = `${ENV.apiBaseUrl}/auth/get/nomUsuari`;
  ...
  if (userLoggedDiv) {
    try {
      ...
      <div class="d-flex align-items-center gap-2 flex-wrap">
        <img src="${ENV.domainImg}/assets_usuaris/${data.avatar}.jpg" alt="Avatar de ${data.username}" class="rounded-circle" width="40" height="40">
