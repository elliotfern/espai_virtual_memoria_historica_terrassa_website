...
try {
    ...
    $sql = "UPDATE db_detinguts_guardia_urbana SET
        idPersona = :idPersona,
        data_empresonament = :data_empresonament,
        data_sortida = :data_sortida,
        motiu_empresonament = :motiu_empresonament,
        qui_ordena_detencio = :qui_ordena_detencio,
        top = :top,
    ...
    $detalls = "Modificació fitxa repressió detinguts Guardia Urbana";
