...
try {
    ...
    $sql = "INSERT INTO db_exiliats (
    data_exili, lloc_partida, lloc_pas_frontera, amb_qui_passa_frontera, 
    primer_desti_exili, primer_desti_data, tipologia_primer_desti, dades_lloc_primer_desti, 
    periple_recorregut, deportat, ultim_desti_exili, tipologia_ultim_desti, 
    participacio_resistencia, dades_resistencia, activitat_politica_exili, 
    activitat_sindical_exili, situacio_legal_espanya, idPersona
    ) VALUES (
        :data_exili, :lloc_partida, :lloc_pas_frontera, :amb_qui_passa_frontera, 
        :primer_desti_exili, :primer_desti_data, :tipologia_primer_desti, :dades_lloc_primer_desti, 
        :periple_recorregut, :deportat, :ultim_desti_exili, :tipologia_ultim_desti, 
    ...
    $detalls = "Creació fitxa repressió exiliats";
