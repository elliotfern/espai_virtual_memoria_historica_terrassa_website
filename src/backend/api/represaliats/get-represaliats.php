...
ORDER BY t.cognom1, t.cognom2, t.nom;";
    ...
    $query = "SELECT a.id, CONCAT(a.cognom1, ' ', a.cognom2, ', ', a.nom) AS nom_complet, a.data_naixement, e.copia_exp, e.num_causa, e.num_registre, a.slug, a.categoria, m.ciutat, u.nom AS nom_usuari,
    ...
    $query = "SELECT 
                a.id, CONCAT(a.cognom1, ' ', a.cognom2, ', ', a.nom) AS nom_complet, a.observacions_internes, a.categoria, a.slug
                FROM db_dades_personals AS a
                WHERE completat = 3
                ORDER BY a.cognom1 ASC;";
