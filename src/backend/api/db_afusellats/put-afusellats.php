...
try {
    ...
    $sql = "UPDATE db_afusellats 
           SET
            idPersona = :idPersona,
            data_execucio = :data_execucio,
            enterrament_lloc = :enterrament_lloc,
            lloc_execucio_enterrament = :lloc_execucio_enterrament,
    ...
    $detalls = "Modificació fitxa repressió afusellat";
