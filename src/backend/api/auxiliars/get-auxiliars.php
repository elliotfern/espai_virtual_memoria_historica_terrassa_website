...
ORDER BY
    ...
    // URL
} else if ($slug === "jutges_instructors") {
    ...
    // URL
} else if ($slug === "secretaris_instructors") {
    ...
    // GET > Presidents tribunals
    // URL
} else if ($slug === "presidents_tribunals") {
    ...
    // GET > Defensors consells de guerra
    // URL
} else if ($slug === "defensors") {
    ...
    // GET > Fiscals consells de guerra
    // URL
} else if ($slug === "fiscals") {
    ...
    // GET > Ponents consells de guerra
    // URL
} else if ($slug === "ponents") {
    ...
    // GET > testimonis de l'acusació consells de guerra
    // URL
} else if ($slug === "testimonis_acusacions") {
