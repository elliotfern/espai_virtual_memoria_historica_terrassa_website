...
if ($slug === 'jutgesInstructors') {
    ...
    try {
        ...
        $sql = "INSERT INTO aux_tribunal_vocals (
                    nom,
                    cognoms,
                    carrec
                ) VALUES (
        ...
        Audit::registrarCanvi(
            ...
            $userId,
            "INSERT",
            "Creació tribunal vocal auxiliar",
    ...
    try {
        ...
        $sql = "INSERT INTO aux_testimonis_acusacions (
                    nom,
                    cognoms,
                    carrec
                ) VALUES (
        ...
        Audit::registrarCanvi(
            ...
            $userId,
            "INSERT",
            "Creació testimoni acusació auxiliar",
            Tables::AUX_TESTIMONIS_ACUSACIONS,
            $id
        );
