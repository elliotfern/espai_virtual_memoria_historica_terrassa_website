...
$routes = [
    ...
    APP_INTRANET . '/base-dades/general/llistat-revisio-geolocalitzacio' => array_merge($defaultProtectedConfig, [
        'view' => BACKEND_URL . $urlIntranetDir['base_dades'] . '/llistat-geolocalitzacio.php'
    ]),
    ...
    APP_INTRANET . $urlIntranet['auxiliars'] . '/modifica-mitja-comunicacio/{id}' => array_merge($defaultProtectedConfig, [
        'view' => BACKEND_URL . $urlIntranetDir['auxiliars'] . '/form-mitja-comunicacio.php'
    ]),

    APP_INTRANET . $urlIntranet['auxiliars'] . '/nou-mitja-comunicacio' => array_merge($defaultProtectedConfig, [
        'view' => BACKEND_URL . $urlIntranetDir['auxiliars'] . '/form-mitja-comunicacio.php'
    ]),
    ...
    APP_INTRANET . $urlIntranet['auxiliars'] . '/fitxa-imatge/{id}' => array_merge($defaultProtectedConfig, [
    ...
    APP_INTRANET . $urlIntranet['auxiliars'] . '/nou-ponent' => array_merge($defaultProtectedConfig, [
        'view' => BACKEND_URL . $urlIntranetDir['auxiliars'] . '/form-ponent.php'
    ]),
    APP_INTRANET . $urlIntranet['auxiliars'] . '/modifica-ponent/{slug}' => array_merge($defaultProtectedConfig, [
        'view' => BACKEND_URL . $urlIntranetDir['auxiliars'] . '/form-ponent.php'
    ]),
    ...
    // REGISTRE CANVIS
    '/gestio/registre-canvis' => ['view' => './intranet/control_registre_canvis/index.php', 'needs_session' => true, 'header_footer' => false, 'header_menu_footer' => true, 'apiSenseHTML' => false],

    '/gestio/control-acces' => ['view' => './intranet/control_registre_canvis/control-acces.php', 'needs_session' => true, 'header_footer' => false, 'header_menu_footer' => true, 'apiSenseHTML' => false],

    // CRONOLOGIA
    '/gestio/cronologia' => ['view' => './intranet/cronologia/index.php', 'needs_session' => true, 'header_footer' => false, 'header_menu_footer' => true, 'apiSenseHTML' => false],

    '/gestio/cronologia/afegir-esdeveniment' => ['view' => './intranet/cronologia/afegir-esdeveniment.php', 'needs_session' => true, 'header_footer' => false, 'header_menu_footer' => true, 'apiSenseHTML' => false],

    '/gestio/cronologia/modifica-esdeveniment/{id}' => ['view' => './intranet/cronologia/afegir-esdeveniment.php', 'needs_session' => true, 'header_footer' => false, 'header_menu_footer' => true, 'apiSenseHTML' => false],
    ...
    APP_INTRANET . $urlIntranet['registre_horari'] . '/taula-registre' => array_merge($defaultProtectedConfig, [
