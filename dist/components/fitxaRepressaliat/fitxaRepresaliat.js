...
import { devDirectory, categorias, convertirFecha, calcularEdadAlMorir, } from "../../config.js";
import { fetchData } from "../../services/api/api.js";
const dayjs = window.dayjs;
export function initButtons(id) {
    const contenedorBotones = document.getElementById("botons1");
    if (!contenedorBotones)
        return; // Asegurarse de que el contenedor de botones existe
    const buttons = [
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (Array.isArray(data)) {
                ...
                categoriasNumericas.forEach((catNum) => {
...
function mostrarCategoria(categoriaNumerica, idPersona) {
    return __awaiter(this, void 0, void 0, function* () {
        const divInfo = document.getElementById("fitxa-categoria");
        if (!divInfo)
            return; // Verifica si el div existe
        ...
        if (!categoriaCache[categoriaNumerica]) {
            try {
                ...
                if (Array.isArray(data)) {
                    const fitxa2 = data[0]; // Hacer cast explícito a 'Fitxa'
...
function mostrarInformacion(tab, idPersona, label) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!cachedData) {
            ...
            try {
                ...
                if (Array.isArray(data)) {
                    cachedData = data[0]; // Hacer cast explícito a 'Fitxa'
                }
                else {
                    throw new Error("La API no devolvió un array.");
                }
        ...
        if (!divInfo || !divAdditionalInfo)
            return;
        // Limpiar el contenido anterior de fitxa
        divInfo.innerHTML = "";
        const sexeText = parseInt(fitxa.sexe, 10) === 1
            ? "Home"
