...
<div class="container" style="margin-bottom:50px;border: 1px solid gray;border-radius: 10px;padding:25px;background-color:#eaeaea">
    <form id="municipiForm">
        <div class="container">
            <div class="row">
                <h2>Inserció dades nova Provincia/Departament</h2>
                ...
                <div class="col-md-4">
                    <label for="provincia" class="form-label negreta">Nom provincia (en el cas francès, Departament):</label>
...
<script>
    ...
    async function enviarFormulario(event) {
        ...
        const devDirectory = `https://${window.location.hostname}`;
        let urlAjax = devDirectory + "/api/auxiliars/put/?type=provincia";
    ...
    async function enviarFormularioPost(event) {
        ...
        const jsonData = JSON.stringify(formData);
        const devDirectory = `https://${window.location.hostname}`;
        let urlAjax = devDirectory + "/api/auxiliars/post/?type=provincia";
