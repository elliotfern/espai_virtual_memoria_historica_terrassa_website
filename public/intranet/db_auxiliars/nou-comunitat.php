    ...
    <form id="municipiForm">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <label for="comunitat" class="form-label negreta">Nom comunitat autònoma (en el cas francès, regió):</label>
                    <input type="text" class="form-control" id="comunitat" name="comunitat" value="">
                </div>
...
<script>
    ...
    async function enviarFormulario(event) {
        ...
        const devDirectory = `https://${window.location.hostname}`;
        let urlAjax = devDirectory + "/api/auxiliars/put/?type=comunitat";
    ...
    async function enviarFormularioPost(event) {
        ...
        const jsonData = JSON.stringify(formData);
        const devDirectory = `https://${window.location.hostname}`;
        let urlAjax = devDirectory + "/api/auxiliars/post/?type=comunitat";
