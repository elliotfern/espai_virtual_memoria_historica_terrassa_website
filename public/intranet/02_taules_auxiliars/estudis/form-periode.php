        ...
        <div class="container">
            <div class="row g-3">
                ...
                <div class="col-md-9 mb-4">
                    <label for="nom_ca" class="form-label negreta">Període històric (català):</label>
                ...
                <?php if (isUserAdmin()) : ?>
                    ...
                    <div class="col-md-6 mb-4">
                        <label for="nom_es" class="form-label negreta">Període històric (castellà):</label>
                        <input type="text" class="form-control" id="nom_es" name="nom_es" value="">
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="nom_en" class="form-label negreta">Període històric (anglès):</label>
                        <input type="text" class="form-control" id="nom_en" name="nom_en" value="">
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="nom_fr" class="form-label negreta">Període històric (francès):</label>
                        <input type="text" class="form-control" id="nom_fr" name="nom_fr" value="">
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="nom_it" class="form-label negreta">Període històric (italià):</label>
                        <input type="text" class="form-control" id="nom_it" name="nom_it" value="">
                    </div>

                    <div class="col-md-6 mb-4">
                        <label for="nom_pt" class="form-label negreta">Període històric (portuguès):</label>
                ...
                <div class="row espai-superior" style="border-top: 1px solid black;padding-top:25px">
                    ...
                    <div class="col d-flex justify-content-end align-items-center">
                        <button class="btn btn-primary" id="btnSubmitPeriode" type="submit">Desa les dades</button>
                    </div>
                </div>
