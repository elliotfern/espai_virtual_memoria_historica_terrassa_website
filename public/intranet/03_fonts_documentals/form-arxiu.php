...
<div class="container" style="margin-bottom:50px;border: 1px solid gray;border-radius: 10px;padding:25px;background-color:#eaeaea">
    <form id="arxiuForm">
        <div class="container">
            <div class="row g-5">
                <h2>Fonts documentals: creació de nou arxiu/fonts documental</h2>
...
<script>
    ...
    async function enviarFormularioPost(event) {
        ...
        const form = document.getElementById("arxiuForm");
        ...
        const devDirectory = `https://${window.location.hostname}`;
        let urlAjax = devDirectory + "/api/fonts_documentals/post/arxiu";
